...
var (
	rootCmd = &cobra.Command{
		Use:        "gcs",
		Short:      "gcs for mini-ray",
		SuggestFor: []string{"gcs"},
		Run:        execute,
	}
...
func execute(cmd *cobra.Command, args []string) {
	...
	lg.Info("--__V__-- gcs starting", zap.String("version", "0.0.1"))
	...
	server := gcs.NewGCS(ctx, lg, workerPool, listenAddr, advertiseAddr, opts...)
	server.Start()
